...
Complete the [pull request template](../../pull-request-template.md).

> **Goal:** Complete the pull request template based on the requirements and scope.
...
- Prompt the user if you need information to fill out the pull request template.
