...
describe('Feature Flags', () => {
  ...
  describe('isEnabled', () => {
    ...
    it('respects environment targeting', () => {
      initializeFeatureFlags([createFlag({ id: 'env-flag', environments: ['production'] })]);
    ...
    it('respects user targeting', () => {
      initializeFeatureFlags([createFlag({ id: 'user-flag', targetUsers: ['beta-user'] })]);
    ...
    it('evaluates all conditions together', () => {
      ...
      // Wrong environment
      expect(isEnabled('complex-flag', { environment: 'staging', userId: 'vip-user' })).toBe(false);
